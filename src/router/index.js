...
const routes = [
  ...
  },
  {
    ...
    name : 'BoardSettings',
    component: () => import(/* webpackChunkName: "NoticeBoard" */ '../pages/BoardSettings.vue'),
    meta : {requiresAuth: true},
  },
  {
  ...
  },
  {
    path:'/:pathMatch(.*)*',
    name: 'notfound',
    component: () => import(/* webpackChunkName: "Register" */ '../pages/404.vue')
  }
...
router.beforeEach(function (to,_,next) {
  ...
  if (to.meta.requiresAuth) {
    ...
    next('/login');
      ...
      if (store.getters.isUserAuth) { router.push('/userhome')}
      next();
    }
});
